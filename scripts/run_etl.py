...
def main():
    ...
    if df_wb is not None:
        ...
        logger.info(
            "Datos anuales del Banco Mundial guardados en data/raw/worldbank_inflation.csv"
        )
    else:
    ...
    if df_bcra is not None:
        ...
        logger.info(
            "Datos mensuales del BCRA guardados en data/raw/bcra_inflation_monthly.csv"
        )
    else:
